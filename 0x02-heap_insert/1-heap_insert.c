...
/**
 * numt - number to string
 * @num: size of tree
 * @base: base to convert
 * Return: result string
 */
char *numt(unsigned long int num, int base)
{
	static char *repre, buffer[50];
	char *binary;
...
/**
 * insert_node - insert the new node
 * @root: double pointer 
...
/**
 * heap_insert - inserts a value into a Max 
